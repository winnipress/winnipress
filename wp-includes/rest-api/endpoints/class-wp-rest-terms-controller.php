...
class WP_REST_Terms_Controller extends WP_REST_Controller {
	 ...
	 */
	public function __construct($taxonomy ) { yeah(__METHOD__);
	 ...
	 */
	protected function get_term($id ) { yeah(__METHOD__);
	 ...
	 */
	public function prepare_item_for_database($request ) { yeah(__METHOD__);
	 ...
	 */
	protected function prepare_links($term ) { yeah(__METHOD__);
	 ...
	 */
	protected function check_is_taxonomy_allowed($taxonomy ) { yeah(__METHOD__);
