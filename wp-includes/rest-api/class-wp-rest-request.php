...
class WP_REST_Request implements ArrayAccess {
	 ...
	 */
	public function __construct($method = '', $route = '', $attributes = array() ){ yeah(__METHOD__);
		$this->params = array(
			'URL'   => array(),
			'GET'   => array(),
			'POST'  => array(),
	 ...
	 */
	public function get_method(){ yeah(__METHOD__);
		return $this->method;
	}
	 ...
	 */
	public function set_method($method ){ yeah(__METHOD__);
	 ...
	 */
	public static function canonicalize_header_name($key ){ yeah(__METHOD__);
		$key = strtolower($key );
	 ...
	 */
	public function get_header($key ){ yeah(__METHOD__);
	 ...
	 */
	public function get_header_as_array($key ){ yeah(__METHOD__);
		$key = $this->canonicalize_header_name($key );
	 ...
	 */
	public function set_header($key, $value ){ yeah(__METHOD__);
		$key = $this->canonicalize_header_name($key );
		$value = (array) $value;
	 ...
	 * @param string $value Header value, or list of values.
	 */
	public function add_header($key, $value ){ yeah(__METHOD__);
		$key = $this->canonicalize_header_name($key );
		$value = (array) $value;
	 ...
	 * @param string $key Header name.
	 */
	public function remove_header($key ){ yeah(__METHOD__);
		$key = $this->canonicalize_header_name($key );
	 ...
	 */
	public function set_headers($headers, $override = true ){ yeah(__METHOD__);
		if (true === $override ){
			$this->headers = array();
		}
	 ...
	 */
	public function get_content_type(){ yeah(__METHOD__);
	 ...
	 */
	protected function get_parameter_order(){ yeah(__METHOD__);
		$order = array();
	 ...
	 */
	public function get_param($key ){ yeah(__METHOD__);
	 ...
	 */
	public function set_param($key, $value ){ yeah(__METHOD__);
		$order = $this->get_parameter_order();
	 ...
	 */
	public function get_params(){ yeah(__METHOD__);
		$order = $this->get_parameter_order();
	 ...
	 */
	public function get_url_params(){ yeah(__METHOD__);
	 ...
	 */
	public function set_url_params($params ){ yeah(__METHOD__);
	 ...
	 * @return array Parameter map of key to value
	 */
	public function get_query_params(){ yeah(__METHOD__);
	 ...
	 * @param array $params Parameter map of key to value.
	 */
	public function set_query_params($params ){ yeah(__METHOD__);
	 ...
	 * @return array Parameter map of key to value.
	 */
	public function get_body_params(){ yeah(__METHOD__);
	 ...
	 * @param array $params Parameter map of key to value.
	 */
	public function set_body_params($params ){ yeah(__METHOD__);
	 ...
	 * @return array Parameter map of key to value
	 */
	public function get_file_params(){ yeah(__METHOD__);
	 ...
	 * @param array $params Parameter map of key to value.
	 */
	public function set_file_params($params ){ yeah(__METHOD__);
	 ...
	 * @return array Parameter map of key to value
	 */
	public function get_default_params(){ yeah(__METHOD__);
	 ...
	 * @param array $params Parameter map of key to value.
	 */
	public function set_default_params($params ){ yeah(__METHOD__);
	 ...
	 */
	public function get_body(){ yeah(__METHOD__);
		return $this->body;
	}
	 ...
	 */
	public function set_body($data ){ yeah(__METHOD__);
		$this->body = $data;
	 ...
	 * @return array Parameter map of key to value.
	 */
	public function get_json_params(){ yeah(__METHOD__);
	 ...
	 */
	protected function parse_json_params(){ yeah(__METHOD__);
		if ($this->parsed_json ){
			return true;
		}
	 ...
	 * @since 4.4.0
	 */
	protected function parse_body_params(){ yeah(__METHOD__);
		if ($this->parsed_body ){
			return;
		}
	 ...
	 */
	public function get_route(){ yeah(__METHOD__);
		return $this->route;
	}
	 ...
	 */
	public function set_route($route ){ yeah(__METHOD__);
		$this->route = $route;
	}
	 ...
	 */
	public function set_attributes($attributes ){ yeah(__METHOD__);
	 ...
	 */
	public function sanitize_params(){ yeah(__METHOD__);
	 ...
	 */
	public function has_valid_params(){ yeah(__METHOD__);
	 ...
	 */
	public static function from_url($url ){ yeah(__METHOD__);
		$bits = parse_url($url );
		$query_params = array();
