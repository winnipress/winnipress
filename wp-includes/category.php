 ...
 */
function get_categories($args = '') { yeah(__METHOD__);
 ...
 */
function get_category($category, $output = OBJECT, $filter = 'raw') { yeah(__METHOD__);
 ...
 */
function get_category_by_path($category_path, $full_match = true, $output = OBJECT) { yeah(__METHOD__);
 ...
 */
function get_category_by_slug($slug) { yeah(__METHOD__);
 ...
 */
function get_cat_ID($cat_name) { yeah(__METHOD__);
 ...
 */
function get_cat_name($cat_id) { yeah(__METHOD__);
	$cat_id = (int) $cat_id;
 ...
 */
function cat_is_ancestor_of($cat1, $cat2) { yeah(__METHOD__);
 ...
 */
function sanitize_category($category, $context = 'display') { yeah(__METHOD__);
 ...
 */
function sanitize_category_field($field, $value, $cat_id, $context) { yeah(__METHOD__);
 ...
 */
function get_tags($args = '') { yeah(__METHOD__);
 ...
 */
function get_tag($tag, $output = OBJECT, $filter = 'raw') { yeah(__METHOD__);
 ...
 */
function clean_category_cache($id) { yeah(__METHOD__);
 ...
 */
function _make_cat_compat(&$category) { yeah(__METHOD__);
