 ...
 */
function create_initial_taxonomies() { yeah(__METHOD__);
	global $wp_rewrite;
 ...
 */
function get_taxonomies($args = array(), $output = 'names', $operator = 'and' ) { yeah(__METHOD__);
 ...
 */
function get_object_taxonomies($object, $output = 'names' ) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 */
function get_taxonomy($taxonomy ) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 */
function taxonomy_exists($taxonomy ) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 */
function is_taxonomy_hierarchical($taxonomy) { yeah(__METHOD__);
	if (!taxonomy_exists($taxonomy) )
		return false;
 ...
 */
function register_taxonomy($taxonomy, $object_type, $args = array() ) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 */
function unregister_taxonomy($taxonomy ) { yeah(__METHOD__);
	if (!taxonomy_exists($taxonomy ) ) {
 ...
 * }
 */
function get_taxonomy_labels($tax ) { yeah(__METHOD__);
 ...
 */
function register_taxonomy_for_object_type($taxonomy, $object_type) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 * @return bool True if successful, false if not.
 */
function unregister_taxonomy_for_object_type($taxonomy, $object_type ) { yeah(__METHOD__);
	global $wp_taxonomies;
 ...
 */
function get_objects_in_term($term_ids, $taxonomies, $args = array() ) { yeah(__METHOD__);
	global $wpdb;
 ...
 * @return array
 */
function get_tax_sql($tax_query, $primary_table, $primary_id_column ) { yeah(__METHOD__);
 ...
 */
function get_term($term, $taxonomy = '', $output = OBJECT, $filter = 'raw' ) { yeah(__METHOD__);
	if (empty($term ) ) {
 ...
 */
function get_term_by($field, $value, $taxonomy = '', $output = OBJECT, $filter = 'raw' ) { yeah(__METHOD__);
 ...
 */
function get_term_children($term_id, $taxonomy ) { yeah(__METHOD__);
	if (!taxonomy_exists($taxonomy ) ) {
		return new WP_Error('invalid_taxonomy', __('Invalid taxonomy.' ) );
	}
 ...
 */
function get_term_field($field, $term, $taxonomy = '', $context = 'display' ) { yeah(__METHOD__);
 ...
 */
function get_term_to_edit($id, $taxonomy ) { yeah(__METHOD__);
 ...
 *                            do not exist.
 */
function get_terms($args = array(), $deprecated = '' ) { yeah(__METHOD__);
 ...
 *                           False on failure.
 */
function add_term_meta($term_id, $meta_key, $meta_value, $unique = false ) { yeah(__METHOD__);
 ...
 */
function delete_term_meta($term_id, $meta_key, $meta_value = '' ) { yeah(__METHOD__);
	// Bail if term meta table is not installed.
	if (get_option('db_version' ) < 34370 ) {
		return false;
	}
 ...
 */
function get_term_meta($term_id, $key = '', $single = false ) { yeah(__METHOD__);
	// Bail if term meta table is not installed.
	if (get_option('db_version' ) < 34370 ) {
		return false;
	}
 ...
 */
function update_term_meta($term_id, $meta_key, $meta_value, $prev_value = '' ) { yeah(__METHOD__);
	// Bail if term meta table is not installed.
	if (get_option('db_version' ) < 34370 ) {
		return false;
	}
 ...
 */
function update_termmeta_cache($term_ids ) { yeah(__METHOD__);
	// Bail if term meta table is not installed.
	if (get_option('db_version' ) < 34370 ) {
		return;
	}
 ...
 */
function has_term_meta($term_id ) { yeah(__METHOD__);
	// Bail if term meta table is not installed.
	if (get_option('db_version' ) < 34370 ) {
		return false;
	}
 ...
 */
function register_term_meta($taxonomy, $meta_key, array $args ) { yeah(__METHOD__);
 ...
 */
function unregister_term_meta($taxonomy, $meta_key ) { yeah(__METHOD__);
 ...
 */
function term_exists($term, $taxonomy = '', $parent = null ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function term_is_ancestor_of($term1, $term2, $taxonomy ) { yeah(__METHOD__);
 ...
 */
function sanitize_term($term, $taxonomy, $context = 'display') { yeah(__METHOD__);
 ...
 */
function sanitize_term_field($field, $value, $term_id, $taxonomy, $context) { yeah(__METHOD__);
 ...
 */
function wp_count_terms($taxonomy, $args = array() ) { yeah(__METHOD__);
 ...
 */
function wp_delete_object_term_relationships($object_id, $taxonomies ) { yeah(__METHOD__);
 ...
 */
function wp_delete_term($term, $taxonomy, $args = array() ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wp_delete_category($cat_ID ) { yeah(__METHOD__);
 ...
 */
function wp_get_object_terms($object_ids, $taxonomies, $args = array()) { yeah(__METHOD__);
 ...
 *                        WP_Error otherwise.
 */
function wp_insert_term($term, $taxonomy, $args = array() ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wp_set_object_terms($object_id, $terms, $taxonomy, $append = false ) { yeah(__METHOD__);
	global $wpdb;
 ...
 * @return array|WP_Error Term taxonomy IDs of the affected terms.
 */
function wp_add_object_terms($object_id, $terms, $taxonomy ) { yeah(__METHOD__);
 ...
 */
function wp_remove_object_terms($object_id, $terms, $taxonomy ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wp_unique_term_slug($slug, $term ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wp_update_term($term_id, $taxonomy, $args = array() ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wp_defer_term_counting($defer=null) { yeah(__METHOD__);
	static $_defer = false;
 ...
 */
function wp_update_term_count($terms, $taxonomy, $do_deferred = false ) { yeah(__METHOD__);
 ...
 */
function wp_update_term_count_now($terms, $taxonomy ) { yeah(__METHOD__);
	$terms = array_map('intval', $terms);
 ...
 */
function clean_object_term_cache($object_ids, $object_type) { yeah(__METHOD__);
 ...
 */
function clean_term_cache($ids, $taxonomy = '', $clean_taxonomy = true) { yeah(__METHOD__);
 ...
 * @param string $taxonomy Taxonomy slug.
 */
function clean_taxonomy_cache($taxonomy ) { yeah(__METHOD__);
 ...
 */
function get_object_term_cache($id, $taxonomy ) { yeah(__METHOD__);
 ...
 */
function update_object_term_cache($object_ids, $object_type) { yeah(__METHOD__);
	if (empty($object_ids) )
		return;
 ...
 */
function update_term_cache($terms, $taxonomy = '' ) { yeah(__METHOD__);
	foreach ((array) $terms as $term ) {
 ...
 */
function _get_term_hierarchy($taxonomy ) { yeah(__METHOD__);
	if (!is_taxonomy_hierarchical($taxonomy) )
		return array();
 ...
 */
function _get_term_children($term_id, $terms, $taxonomy, &$ancestors = array() ) { yeah(__METHOD__);
	$empty_array = array();
	if (empty($terms) )
		return $empty_array;
 ...
 */
function _pad_term_counts(&$terms, $taxonomy ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function _prime_term_caches($term_ids, $update_meta_cache = true ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function _update_post_term_count($terms, $taxonomy ) { yeah(__METHOD__);
	global $wpdb;
 ...
 * @param object $taxonomy Current taxonomy object of terms.
 */
function _update_generic_term_count($terms, $taxonomy ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function _split_shared_term($term_id, $term_taxonomy_id, $record = true ) { yeah(__METHOD__);
	global $wpdb;
 ...
 * @global wpdb $wpdb WordPress database abstraction object.
 */
function _wp_batch_split_terms() { yeah(__METHOD__);
	global $wpdb;
 ...
 * @since 4.3.0
 */
function _wp_check_for_scheduled_split_terms() { yeah(__METHOD__);
 ...
 * @param string $taxonomy         Taxonomy for the split term.
 */
function _wp_check_split_default_terms($term_id, $new_term_id, $term_taxonomy_id, $taxonomy ) { yeah(__METHOD__);
	if ('category' != $taxonomy ) {
		return;
	}
 ...
 * @param string $taxonomy         Taxonomy for the split term.
 */
function _wp_check_split_terms_in_menus($term_id, $new_term_id, $term_taxonomy_id, $taxonomy ) { yeah(__METHOD__);
	global $wpdb;
 ...
 * @param string $taxonomy         Taxonomy for the split term.
 */
function _wp_check_split_nav_menu_terms($term_id, $new_term_id, $term_taxonomy_id, $taxonomy ) { yeah(__METHOD__);
 ...
 */
function wp_get_split_terms($old_term_id ) { yeah(__METHOD__);
 ...
 */
function wp_get_split_term($old_term_id, $taxonomy ) { yeah(__METHOD__);
 ...
 */
function wp_term_is_shared($term_id ) { yeah(__METHOD__);
	global $wpdb;
 ...
 */
function get_term_link($term, $taxonomy = '' ) { yeah(__METHOD__);
	global $wp_rewrite;
 ...
 * }
 */
function the_taxonomies($args = array() ) { yeah(__METHOD__);
	$defaults = array(
		'post' => 0,
		'before' => '',
		'sep' => ' ',
 ...
 */
function get_the_taxonomies($post = 0, $args = array() ) { yeah(__METHOD__);
	$post = get_post($post );
 ...
 */
function get_post_taxonomies($post = 0 ) { yeah(__METHOD__);
	$post = get_post($post );
 ...
 */
function is_object_in_term($object_id, $taxonomy, $terms = null ) { yeah(__METHOD__);
 ...
 */
function is_object_in_taxonomy($object_type, $taxonomy ) { yeah(__METHOD__);
	$taxonomies = get_object_taxonomies($object_type );
	if (empty($taxonomies ) ) {
		return false;
	}
 ...
 */
function get_ancestors($object_id = 0, $object_type = '', $resource_type = '' ) { yeah(__METHOD__);
	$object_id = (int) $object_id;
 ...
 */
function wp_get_term_taxonomy_parent_id($term_id, $taxonomy ) { yeah(__METHOD__);
	$term = get_term($term_id, $taxonomy );
 ...
 */
function wp_check_term_hierarchy_for_loops($parent, $term_id, $taxonomy ) { yeah(__METHOD__);
