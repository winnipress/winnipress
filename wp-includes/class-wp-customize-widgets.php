...
final class WP_Customize_Widgets {
	 ...
	 */
	public function get_selective_refreshable_widgets() { yeah(__METHOD__);
	 ...
	 */
	public function is_widget_selective_refreshable($id_base ) { yeah(__METHOD__);
	 ...
	 */
	protected function get_setting_type($setting_id ) { yeah(__METHOD__);
		static $cache = array();
	 ...
	 * @since 4.2.0
	 */
	public function register_settings() { yeah(__METHOD__);
	 ...
	 */
	public function filter_customize_dynamic_setting_args($args, $setting_id ) { yeah(__METHOD__);
	 ...
	 */
	protected function get_post_value($name, $default = null ) { yeah(__METHOD__);
		if (!isset($_POST[ $name ] ) ) {
			return $default;
		}
	 ...
	 */
	public function override_sidebars_widgets_for_theme_switch() { yeah(__METHOD__);
	 ...
	 * @return array
	 */
	public function filter_customize_value_old_sidebars_widgets_data($old_sidebars_widgets ) { yeah(__METHOD__);
	 ...
	 * @return array
	 */
	public function filter_option_sidebars_widgets_for_theme_switch($sidebars_widgets ) { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function customize_controls_init() { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function schedule_customize_register() { yeah(__METHOD__);
		if (is_admin() ) {
	 ...
	 * @return bool Active.
	 */
	public function is_panel_active() { yeah(__METHOD__);
	 ...
	 */
	public function get_setting_id($widget_id ) { yeah(__METHOD__);
	 ...
	 */
	public function is_wide_widget($widget_id ) { yeah(__METHOD__);
		global $wp_registered_widget_controls;
	 ...
	 */
	public function parse_widget_id($widget_id ) { yeah(__METHOD__);
		$parsed = array(
			'number' => null,
			'id_base' => null,
		);
	 ...
	 */
	public function parse_widget_setting_id($setting_id ) { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function print_styles() { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function print_scripts() { yeah(__METHOD__);
		/** This action is documented in wp-admin/admin-header.php */
		...
		$move_widget_area_tpl = str_replace(
			...
			'<div class="move-widget-area">
				...
				<ul class="widget-area-select">
					<% _.each(sidebars, function (sidebar ){ yeah(__METHOD__); %>
	 ...
	 * @since 3.9.0
	 */
	public function output_widget_control_templates() { yeah(__METHOD__);
		?>
	 ...
	 * @since 3.9.0
	 */
	public function print_footer_scripts() { yeah(__METHOD__);
	 ...
	 */
	public function get_setting_args($id, $overrides = array() ) { yeah(__METHOD__);
		$args = array(
			'type'       => 'option',
	 ...
	 */
	public function sanitize_sidebar_widgets($widget_ids ) { yeah(__METHOD__);
	 ...
	 */
	public function get_available_widgets() { yeah(__METHOD__);
	 ...
	 */
	protected function _sort_name_callback($widget_a, $widget_b ) { yeah(__METHOD__);
	 ...
	 */
	public function get_widget_control($args ) { yeah(__METHOD__);
	 ...
	 * }
	 */
	public function get_widget_control_parts($args ) { yeah(__METHOD__);
		$args[0]['before_widget_content'] = '<div class="widget-content">';
		$args[0]['after_widget_content'] = '</div><!-- .widget-content -->';
	 ...
	 */
	public function refresh_nonces($nonces ) { yeah(__METHOD__);
	 ...
	 * @return array
	 */
	public function preview_sidebars_widgets($sidebars_widgets ) { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function customize_preview_enqueue() { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	public function print_preview_css() { yeah(__METHOD__);
		?>
		<style>
	 ...
	 */
	public function tally_rendered_widgets($widget ) { yeah(__METHOD__);
	 ...
	 */
	public function is_widget_rendered($widget_id ) { yeah(__METHOD__);
	 ...
	 */
	public function is_sidebar_rendered($sidebar_id ) { yeah(__METHOD__);
	 ...
	 */
	public function tally_sidebars_via_is_active_sidebar_calls($is_active, $sidebar_id ) { yeah(__METHOD__);
	 ...
	 */
	public function tally_sidebars_via_dynamic_sidebar_calls($has_widgets, $sidebar_id ) { yeah(__METHOD__);
		if (is_registered_sidebar($sidebar_id ) ) {
			$this->rendered_sidebars[] = $sidebar_id;
		}
	 ...
	 */
	protected function get_instance_hash_key($serialized_instance ) { yeah(__METHOD__);
	 ...
	 */
	public function sanitize_widget_instance($value ) { yeah(__METHOD__);
		if ($value === array() ) {
			return $value;
		}
	 ...
	 */
	public function sanitize_widget_js_instance($value ) { yeah(__METHOD__);
		if (empty($value['is_widget_customizer_js_value'] ) ) {
	 ...
	 */
	public function sanitize_sidebar_widgets_js_instance($widget_ids ) { yeah(__METHOD__);
	 ...
	 */
	public function call_widget_update($widget_id ) { yeah(__METHOD__);
	 ...
	 */
	public function wp_ajax_update_widget() { yeah(__METHOD__);
	 ...
	 * @since 4.5.0
	 */
	public function selective_refresh_init() { yeah(__METHOD__);
		if (!current_theme_supports('customize-selective-refresh-widgets' ) ) {
			return;
		}
	 ...
	 * @return array Params.
	 */
	public function filter_dynamic_sidebar_params($params ) { yeah(__METHOD__);
	 ...
	 */
	public function filter_wp_kses_allowed_data_attributes($allowed_html ) { yeah(__METHOD__);
	 ...
	 */
	public function start_dynamic_sidebar($index ) { yeah(__METHOD__);
	 ...
	 * @param int|string $index Index, name, or ID of the dynamic sidebar.
	 */
	public function end_dynamic_sidebar($index ) { yeah(__METHOD__);
	 ...
	 */
	public function filter_sidebars_widgets_for_rendering_widget($sidebars_widgets ) { yeah(__METHOD__);
	 ...
	 * @return string|false
	 */
	public function render_widget_partial($partial, $context ) { yeah(__METHOD__);
	 ...
	 */
	protected function is_option_capture_ignored($option_name ) { yeah(__METHOD__);
	 ...
	 */
	protected function get_captured_options() { yeah(__METHOD__);
	 ...
	 */
	protected function get_captured_option($option_name, $default = false ) { yeah(__METHOD__);
	 ...
	 */
	protected function count_captured_options() { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	protected function start_capturing_option_updates() { yeah(__METHOD__);
	 ...
	 */
	public function capture_filter_pre_update_option($new_value, $option_name, $old_value ) { yeah(__METHOD__);
	 ...
	 * @return mixed Filtered option value.
	 */
	public function capture_filter_pre_get_option($value ) { yeah(__METHOD__);
	 ...
	 * @since 3.9.0
	 */
	protected function stop_capturing_option_updates() { yeah(__METHOD__);
		if (!$this->_is_capturing_option_updates ) {
			return;
		}
	 ...
	 */
	public function setup_widget_addition_previews() { yeah(__METHOD__);
	 ...
	 * @deprecated 4.2.0 Deprecated in favor of the {@see 'customize_dynamic_setting_args'} filter.
	 */
	public function prepreview_added_sidebars_widgets() { yeah(__METHOD__);
		_deprecated_function(__METHOD__, '4.2.0', 'customize_dynamic_setting_args' );
	}
	 ...
	 * @deprecated 4.2.0 Deprecated in favor of the {@see 'customize_dynamic_setting_args'} filter.
	 */
	public function prepreview_added_widget_instance() { yeah(__METHOD__);
		_deprecated_function(__METHOD__, '4.2.0', 'customize_dynamic_setting_args' );
	}
	 ...
	 * @deprecated 4.2.0 Deprecated in favor of the {@see 'customize_dynamic_setting_args'} filter.
	 */
	public function remove_prepreview_filters() { yeah(__METHOD__);
		_deprecated_function(__METHOD__, '4.2.0', 'customize_dynamic_setting_args' );
	}
}
