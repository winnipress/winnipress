 ...
 */
function set_current_user($id, $name = ''){ yeah(__METHOD__);
 ...
 */
function get_currentuserinfo(){ yeah(__METHOD__);
 ...
 */
function get_userdatabylogin($user_login){ yeah(__METHOD__);
 ...
 * @return bool|object False on failure, User DB row object
 */
function get_user_by_email($email){ yeah(__METHOD__);
 ...
 */
function wp_setcookie($username, $password = '', $already_md5 = false, $home = '', $siteurl = '', $remember = false){ yeah(__METHOD__);
 ...
 */
function wp_clearcookie(){ yeah(__METHOD__);
 ...
 */
function wp_get_cookie_login(){ yeah(__METHOD__);
 ...
 */
function wp_login($username, $password, $deprecated = ''){ yeah(__METHOD__);
...
if (!class_exists('wp_atom_server', false ) ){
	class wp_atom_server {
		...
		public static function __callStatic($name, $arguments ){ yeah(__METHOD__);
			_deprecated_function(__CLASS__ . '::' . $name, '3.5.0', 'the Atom Publishing Protocol plugin' );
		}
	}
}
