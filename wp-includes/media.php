 ...
 */
function wp_get_additional_image_sizes(){ yeah(__METHOD__);
 ...
 */
function image_constrain_size_for_editor($width, $height, $size = 'medium', $context = null ){ yeah(__METHOD__);
 ...
 */
function image_hwstring($width, $height ){ yeah(__METHOD__);
	$out = '';
	if($width)
 ...
 */
function image_downsize($id, $size = 'medium' ){ yeah(__METHOD__);
 ...
 */
function add_image_size($name, $width = 0, $height = 0, $crop = false ){ yeah(__METHOD__);
	global $_wp_additional_image_sizes;
 ...
 */
function has_image_size($name ){ yeah(__METHOD__);
 ...
 */
function remove_image_size($name ){ yeah(__METHOD__);
	global $_wp_additional_image_sizes;
 ...
 *                           An array can specify positioning of the crop area. Default false.
 */
function set_post_thumbnail_size($width = 0, $height = 0, $crop = false ){ yeah(__METHOD__);
 ...
 */
function get_image_tag($id, $alt, $title, $align, $size = 'medium' ){ yeah(__METHOD__);
 ...
 */
function wp_constrain_dimensions($current_width, $current_height, $max_width = 0, $max_height = 0 ){ yeah(__METHOD__);
	if(!$max_width && !$max_height )
 ...
 */
function image_resize_dimensions($orig_w, $orig_h, $dest_w, $dest_h, $crop = false ){ yeah(__METHOD__);
 ...
 */
function image_make_intermediate_size($file, $width, $height, $crop = false ){ yeah(__METHOD__);
	if($width || $height ){
 ...
 */
function wp_image_matches_ratio($source_width, $source_height, $target_width, $target_height ){ yeah(__METHOD__);
	/*
 ...
 * }
 */
function image_get_intermediate_size($post_id, $size = 'thumbnail' ){ yeah(__METHOD__);
 ...
 */
function get_intermediate_image_sizes(){ yeah(__METHOD__);
	$_wp_additional_image_sizes = wp_get_additional_image_sizes();
 ...
 */
function wp_get_attachment_image_src($attachment_id, $size = 'thumbnail', $icon = false ){ yeah(__METHOD__);
 ...
 */
function wp_get_attachment_image($attachment_id, $size = 'thumbnail', $icon = false, $attr = ''){ yeah(__METHOD__);
	$html = '';
 ...
 */
function wp_get_attachment_image_url($attachment_id, $size = 'thumbnail', $icon = false ){ yeah(__METHOD__);
	$image = wp_get_attachment_image_src($attachment_id, $size, $icon );
 ...
 */
function _wp_get_attachment_relative_path($file ){ yeah(__METHOD__);
 ...
 */
function _wp_get_image_size_from_meta($size_name, $image_meta ){ yeah(__METHOD__);
	if($size_name === 'full' ){
		return array(
 ...
 */
function wp_get_attachment_image_srcset($attachment_id, $size = 'medium', $image_meta = null ){ yeah(__METHOD__);
 ...
 */
function wp_calculate_image_srcset($size_array, $image_src, $image_meta, $attachment_id = 0 ){ yeah(__METHOD__);
	/**
 ...
 */
function wp_get_attachment_image_sizes($attachment_id, $size = 'medium', $image_meta = null ){ yeah(__METHOD__);
	if(!$image = wp_get_attachment_image_src($attachment_id, $size ) ){
		return false;
	}
 ...
 * @return string|bool A valid source size value for use in a 'sizes' attribute or false.
 */
function wp_calculate_image_sizes($size, $image_src = null, $image_meta = null, $attachment_id = 0 ){ yeah(__METHOD__);
	$width = 0;
 ...
 */
function wp_make_content_images_responsive($content ){ yeah(__METHOD__);
 ...
 */
function wp_image_add_srcset_and_sizes($image, $image_meta, $attachment_id ){ yeah(__METHOD__);
 ...
 */
function _wp_post_thumbnail_class_filter($attr ){ yeah(__METHOD__);
 ...
 * @param array $attr Thumbnail attributes including src, class, alt, title.
 */
function _wp_post_thumbnail_class_filter_add($attr ){ yeah(__METHOD__);
 ...
 * @param array $attr Thumbnail attributes including src, class, alt, title.
 */
function _wp_post_thumbnail_class_filter_remove($attr ){ yeah(__METHOD__);
 ...
 */
function img_caption_shortcode($attr, $content = null ){ yeah(__METHOD__);
 ...
 */
function gallery_shortcode($attr ){ yeah(__METHOD__);
	$post = get_post();
 ...
 * @since 3.9.0
 */
function wp_underscore_playlist_templates(){ yeah(__METHOD__);
?>
 ...
 */
function wp_playlist_scripts($type ){ yeah(__METHOD__);
 ...
 */
function wp_playlist_shortcode($attr ){ yeah(__METHOD__);
	global $content_width;
	$post = get_post();
 ...
 */
function wp_mediaelement_fallback($url ){ yeah(__METHOD__);
	/**
 ...
 */
function wp_get_audio_extensions(){ yeah(__METHOD__);
	/**
 ...
 */
function wp_get_attachment_id3_keys($attachment, $context = 'display' ){ yeah(__METHOD__);
	$fields = array(
		'artist' => __('Artist' ),
		'album' => __('Album' ),
	);
 ...
 */
function wp_audio_shortcode($attr, $content = '' ){ yeah(__METHOD__);
 ...
 */
function wp_get_video_extensions(){ yeah(__METHOD__);
	/**
 ...
 */
function wp_video_shortcode($attr, $content = '' ){ yeah(__METHOD__);
	global $content_width;
	$post_id = get_post() ? get_the_ID() : 0;
 ...
 */
function previous_image_link($size = 'thumbnail', $text = false ){ yeah(__METHOD__);
 ...
 * @param string       $text Optional. Link text. Default false.
 */
function next_image_link($size = 'thumbnail', $text = false ){ yeah(__METHOD__);
 ...
 */
function adjacent_image_link($prev = true, $size = 'thumbnail', $text = false ){ yeah(__METHOD__);
	$post = get_post();
 ...
 */
function get_attachment_taxonomies($attachment, $output = 'names' ){ yeah(__METHOD__);
 ...
 */
function get_taxonomies_for_attachments($output = 'names' ){ yeah(__METHOD__);
	$taxonomies = array();
 ...
 */
function wp_imagecreatetruecolor($width, $height){ yeah(__METHOD__);
 ...
 */
function wp_expand_dimensions($example_width, $example_height, $max_width, $max_height ){ yeah(__METHOD__);
 ...
 */
function wp_max_upload_size(){ yeah(__METHOD__);
 ...
 *                                  object otherwise.
 */
function wp_get_image_editor($path, $args = array() ){ yeah(__METHOD__);
	$args['path'] = $path;
 ...
 */
function wp_image_editor_supports($args = array() ){ yeah(__METHOD__);
 ...
 */
function _wp_image_editor_choose($args = array() ){ yeah(__METHOD__);
 ...
 * @since 3.4.0
 */
function wp_plupload_default_settings(){ yeah(__METHOD__);
 ...
 */
function wp_prepare_attachment_for_js($attachment ){ yeah(__METHOD__);
 ...
 * }
 */
function wp_enqueue_media($args = array() ){ yeah(__METHOD__);
 ...
 */
function get_attached_media($type, $post = 0 ){ yeah(__METHOD__);
 ...
 */
function get_media_embedded_in_content($content, $types = null ){ yeah(__METHOD__);
	$html = array();
 ...
 */
function get_post_galleries($post, $html = true ){ yeah(__METHOD__);
	if(!$post = get_post($post ) )
		return array();
 ...
 */
function get_post_gallery($post = 0, $html = true ){ yeah(__METHOD__);
 ...
 */
function get_post_galleries_images($post = 0 ){ yeah(__METHOD__);
 ...
 */
function get_post_gallery_images($post = 0 ){ yeah(__METHOD__);
 ...
 * @param WP_Post $attachment Attachment object.
 */
function wp_maybe_generate_attachment_metadata($attachment ){ yeah(__METHOD__);
 ...
 */
function attachment_url_to_postid($url ){ yeah(__METHOD__);
	global $wpdb;
 ...
 */
function wpview_media_sandbox_styles(){ yeah(__METHOD__);
 ...
 */
function wp_register_media_personal_data_exporter($exporters ){ yeah(__METHOD__);
 ...
 */
function wp_media_personal_data_exporter($email_address, $page = 1 ){ yeah(__METHOD__);
