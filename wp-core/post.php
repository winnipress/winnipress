...
function wp_count_posts($type = 'post', $perm = ''){
	...
	if(false !== $counts){
		/** This filter is documented in wp-core/post.php */
...
function wp_publish_post($post){
	...
	/** This action is documented in wp-core/post.php */
...
function wp_mime_type_icon($mime = 0){
	...
	if(empty($icon)){
		...
		if(!is_array($icon_files)){
			 ...
			 */
			$icon_dir = apply_filters('icon_dir', ABSPATH . 'wp-core/images/media');
