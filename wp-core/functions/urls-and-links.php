...
function get_search_comments_feed_link($search_query = '', $feed = ''){
	...
	/** This filter is documented in wp-core/link-template.php */
 ...
 * (e.g.  or the admin/ folder) are accessible.
 *
 ...
 * (e.g.  the admin/ folder) are accessible.
 *
 * Returns the 'site_url' option with the appropriate protocol, 'https' if
...
function includes_url($path = '', $scheme = null ){
	 ...
	 * @param string $path Path relative to the URL to the wp-core directory. Blank string
