			...
			foreach( (array) $results as $result){
				if( $result->post_date != '0000-00-00 00:00:00'){
					...
					if( $result->post_title){
						/** This filter is documented in wp-core/post-template.php */
...
function wp_resource_hints(){
	 ...
	 */
	/** This filter is documented in wp-core/formatting.php */
...
function wp_enqueue_editor(){
	wp_enqueue_script('tiny-mce-js', '/wp-core/tinymce/tinymce.min.js');
}

function wp_enqueue_default_admin_styles(){
	wp_enqueue_style('default-admin-css', '/admin/css/admin.css');
	wp_enqueue_style('line-awesome-icons', '/admin/icons/line-awesome-1.3.0/css/line-awesome.min.css');
}
