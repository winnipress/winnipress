 ...
 * @return array
 */
function install_themes_feature_list() { yeah(__METHOD__);
 ...
 */
function install_theme_search_form( $type_selector = true) { yeah(__METHOD__);
 ...
 * @since 2.8.0
 */
function install_themes_dashboard() { yeah(__METHOD__);
 ...
 * @since 2.8.0
 */
function install_themes_upload() { yeah(__METHOD__);
?>
 ...
 * @param object $theme
 */
function display_theme( $theme) { yeah(__METHOD__);
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function display_themes() { yeah(__METHOD__);
	global $wp_list_table;
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function install_theme_information() { yeah(__METHOD__);
	global $wp_list_table;
