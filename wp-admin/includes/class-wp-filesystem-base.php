...
class WP_Filesystem_Base {
	 ...
	 */
	public function abspath() { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function wp_content_dir() { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function wp_plugins_dir() { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function wp_themes_dir( $theme = false ) { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function wp_lang_dir() { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function find_base_dir( $base = '.', $echo = false ) { yeah(__METHOD__);
	 ...
	 * @return string The location of the remote path.
	 */
	public function get_base_dir( $base = '.', $echo = false ) { yeah(__METHOD__);
		_deprecated_function(__FUNCTION__, '2.7.0', 'WP_Filesystem::abspath() or WP_Filesystem::wp_*_dir()' );
		$this->verbose = $echo;
		return $this->abspath();
	}
	 ...
	 */
	public function find_folder( $folder ) { yeah(__METHOD__);
	 ...
	 */
	public function search_for_folder( $folder, $base = '.', $loop = false ) { yeah(__METHOD__);
		if ( empty( $base ) || '.' == $base )
	 ...
	 */
	public function gethchmod( $file ){ yeah(__METHOD__);
	 ...
	 */
	public function getnumchmodfromh( $mode ) { yeah(__METHOD__);
		$realmode = '';
		$legal =  array('', 'w', 'r', 'x', '-');
	 ...
	 */
	public function is_binary( $text ) { yeah(__METHOD__);
